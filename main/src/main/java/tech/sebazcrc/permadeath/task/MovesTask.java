    ...
    public void run() {
        ...
        if (currentPitchRotation < 0) {
            ...
            if (!spawnedPaticles) {
                ...
                ArrayList<Location> locations = new ArrayList<>(List.of(
                    main.endWorld.getHighestBlockAt(dragon.getLocation().add(7, 0, 7)).getLocation(),
                    main.endWorld.getHighestBlockAt(dragon.getLocation().add(7, 0, 0)).getLocation(),
                    main.endWorld.getHighestBlockAt(dragon.getLocation().add(7, 0, -7)).getLocation(),
                    main.endWorld.getHighestBlockAt(dragon.getLocation().add(0, 0, -7)).getLocation(),
                    main.endWorld.getHighestBlockAt(dragon.getLocation().add(0, 0, 7)).getLocation(),
                    main.endWorld.getHighestBlockAt(dragon.getLocation().add(-7, 0, 7)).getLocation(),
                    main.endWorld.getHighestBlockAt(dragon.getLocation().add(-7, 0, 0)).getLocation(),
                    main.endWorld.getHighestBlockAt(dragon.getLocation().add(-7, 0, -7)).getLocation()
