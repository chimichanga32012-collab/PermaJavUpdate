...
public class DateManager {
    ...
    public DateManager() {
        ...
        dai = this; // Asegura la inicialización de la instancia estática
    ...
    public void setDay(CommandSender sender, String args1) {
        ...
        DateManager.getInstance().setNewDate(add.format(DateTimeFormatter.ISO_LOCAL_DATE));
    ...
    public String getDateForDayOne() {
        ...
        return w.format(DateTimeFormatter.ISO_LOCAL_DATE);
    }
    ...
    private void saveFile() {
        try {
            ...
            instance.getLogger().severe("Ha ocurrido un error al guardar el archivo 'fecha.yml'");
        }
    }
    ...
    private void reloadFile() {
        try {
            ...
            instance.getLogger().severe("Ha ocurrido un error al cargar/recargar el archivo 'fecha.yml'");
        }
    }
