...
public class EndDataManager {
    ...
    public EndDataManager(Main instance) {
        ...
        if (!endFile.exists()) {
            try {
                ...
                instance.getLogger().severe("Ha ocurrido un error al crear el archivo 'endConfig.yml'");
            }
        }
        ...
        if (!config.contains("PlacedObsidian")) {
            config.set("PlacedObsidian", new ArrayList<String>());
        }
    ...
    public void loadSettings() {
        this.timeList = config.getIntegerList("EnderCrystalRegenTime");
    }
    ...
    public void saveFile() {
        try {
            ...
            instance.getLogger().severe("Ha ocurrido un error al guardar el archivo 'endConfig.yml'");
        }
    }
    ...
    public void reloadFile() {
        try {
            ...
            instance.getLogger().severe("Ha ocurrido un error al cargar/recargar el archivo 'endConfig.yml'");
        }
        loadSettings();
    }
}
