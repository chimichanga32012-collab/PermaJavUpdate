...
public class HiddenStringUtils {
    ...
    // Usamos el carácter nativo del código de color de Minecraft (§) de forma directa
    private static final char COLOR_CHAR = '\u00A7';
    
    private static final String SEQUENCE_HEADER = "" + COLOR_CHAR + "r" + COLOR_CHAR + "n" + COLOR_CHAR + "r";
    private static final String SEQUENCE_FOOTER = "" + COLOR_CHAR + "r" + COLOR_CHAR + "o" + COLOR_CHAR + "r";
    ...
    public static String extractHiddenString(String input) {
        ...
        return colorsToString(extracted);
    }
